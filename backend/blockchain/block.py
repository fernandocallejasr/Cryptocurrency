...
class Block():
	...
	def mine_block(last_block, data):
		"""Mines (creates) a block based on the given last block and data, until a block hash
	...
	@staticmethod
	def genesis():
		"""Generates de genesis (first) block.
		"""
		#return Block(
		...
		return Block(**GENESIS_DATA) # Unpacks all the dictionary GENESIS_DATA in the order it is defined corresponding the order of the parameters of Block class

	@staticmethod
	def from_json(block_json):
		"""Deserealize a block's json representation back into a block instance
		"""
	...
	def adjust_difficulty(last_block, new_timestamp):
		"""Calculates the adjusted difficulty according to the MINE_RATE
		   Will increase the difficulty for fast mining
		   Will decrease the difficulty for slow mining
		"""
		time_difference = new_timestamp - last_block.timestamp
